...
Keep all recognizable traits from the uploaded image (skin tone, hairstyle, facial structure, and clothing) so the person remains identifiable. Redraw them in the satirical parody style of the reference image: extreme musculature (oversized biceps, chest, thighs), extra long chin, angular nose, sharp jawline, exaggerated hair in bright yellow triangular spikes, and bold facial exaggerations. Apply bold black outlines, crooked/uneven lines, flat 2D coloring with no shading, and a rough, intentionally ugly comic aesthetic, like Microsoft Paint drawings. Clothing should match the original from the uploaded image but simplified into flat neon cartoon colors. The result should blend the individuality of the uploaded image with the absurd, hyper-masculine parody style of the reference image.`;  
