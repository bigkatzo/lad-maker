...
Keep all recognizable traits from the uploaded image (skin tone, hairstyle, facial structure, and clothing) so the person remains identifiable. Redraw them in the satirical parody style of the reference image with these CRITICAL FEATURES: an EXTREMELY RIDICULOUSLY LONG CHIN that extends dramatically downward (at least 3x normal length), massive oversized biceps and forearms, enormous chest muscles, huge thighs, and most importantly - position them in a WEIRD BIZARRE BODYBUILDER POSE with arms flexed in awkward unnatural angles, legs spread in an exaggerated wide stance or strange twisted position, angular nose, sharp jawline, exaggerated hair in bright yellow triangular spikes, and bold facial exaggerations. The chin should be absurdly elongated and prominent. Apply bold black outlines, crooked/uneven lines, flat 2D coloring with no shading, and a rough, intentionally ugly comic aesthetic, like Microsoft Paint drawings. Clothing should match the original from the uploaded image but simplified into flat neon cartoon colors. The result should blend the individuality of the uploaded image with the absurd, hyper-masculine parody style of the reference image, emphasizing the ridiculously long chin and weird bodybuilder pose.`;  
